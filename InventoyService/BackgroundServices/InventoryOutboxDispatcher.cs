...
public sealed class InventoryOutboxDispatcher(SqlConnectionFactory connectionFactory) : BackgroundService
{
...
WHERE EventId = @EventId";
    ...
    private static IReadOnlyList<string> ResolveConsumers(string eventType)
    {
        return eventType switch
        {
            ...
            "InventoryFailed" => ["OrderService", "PaymentService"],
            _ => []
        };
    }
