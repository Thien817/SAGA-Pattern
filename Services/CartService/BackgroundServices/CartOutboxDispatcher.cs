...
public sealed class CartOutboxDispatcher(SqlConnectionFactory connectionFactory) : BackgroundService
{
...
END";
                ...
                insertCmd.Parameters.AddWithValue("@EventId", outboxEvent.EventId);
